    ...
    public void insertUpdateDeleteCourse(char operation, Integer id, String label, Integer hours)
    {
        ...
        if(operation == 'i')
        {
            try {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Cursul a fost adaugat");
                }
        ...
        {
            int yesOrNo = JOptionPane.showConfirmDialog(null, "Notele vor fi sterse","Sterge notele",JOptionPane.OK_CANCEL_OPTION,0);
            ...
            try {
                ...
                if(ps.executeUpdate()>0)
                {
                    JOptionPane.showMessageDialog(null, "Cursul a fost eliminat din baza de date");
                }
